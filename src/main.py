...
def main():
    ...
    # Create an exit sensor object with id 2, is_active True, and car_park moondalup_car_park
    sensor_2 = ExitSensor(2, True, moondalup_car_park)

    # Create a display object with id 1, message "Welcome to Moondalup", is_on True, and car_park moondalup_car_park
