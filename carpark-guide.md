...
| ---------- |--------------|-------------|
| `CarPark`  | available_bays, location   | add_car, remove_car           |
| `Sensor`   | number_plate, temperature  | scan_number_plate, get_temperature_reading    |
| `Display`  | message, text_size         | update_information, show_information   |
...
> In the CarPark unit tests, because the register method is defined in the CarPark Class.
...
![Added methods to the car park class](images/methods-to-car-park2.png)
